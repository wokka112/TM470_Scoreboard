...
public class TestData {
    ...
    public static final GameRecord GAME_RECORD_5 = new GameRecord(23, GROUP_3.getId(), BOARD_GAME_3.getBgName(), BOARD_GAME_3.getDifficulty(), new Date(),
            false, PlayMode.PlayModeEnum.SOLITAIRE, 3, false);

    public static final List<GameRecord> GAME_RECORDS = Arrays.asList(GAME_RECORD_1, GAME_RECORD_2, GAME_RECORD_3, GAME_RECORD_4, GAME_RECORD_5);

    public static final PlayerTeam PLAYER_TEAM_1 = new PlayerTeam(24, 1, GAME_RECORD_1.getId(), 1, 30);
    public static final PlayerTeam PLAYER_TEAM_2 = new PlayerTeam(25, 2, GAME_RECORD_1.getId(), 2, 20);
    public static final PlayerTeam PLAYER_TEAM_3 = new PlayerTeam(26, 3, GAME_RECORD_1.getId(), 2, 20);
    public static final PlayerTeam PLAYER_TEAM_4 = new PlayerTeam(27, 4, GAME_RECORD_1.getId(), 4, 0);
    public static final PlayerTeam PLAYER_TEAM_5 = new PlayerTeam(28, 1, GAME_RECORD_2.getId(), 1, 60);
    public static final PlayerTeam PLAYER_TEAM_6 = new PlayerTeam(29, 1, GAME_RECORD_3.getId(), 1, 20);
    public static final PlayerTeam PLAYER_TEAM_7 = new PlayerTeam(30, 1, GAME_RECORD_4.getId(), 1, 20);

    public static final List<PlayerTeam> PLAYER_TEAMS = Arrays.asList(PLAYER_TEAM_1, PLAYER_TEAM_2, PLAYER_TEAM_3, PLAYER_TEAM_4, PLAYER_TEAM_5, PLAYER_TEAM_6, PLAYER_TEAM_7);

    public static final Player PLAYER_1 = new Player(31, PLAYER_TEAM_1.getId(), MEMBER_1.getNickname());
    public static final Player PLAYER_2 = new Player(32, PLAYER_TEAM_2.getId(), MEMBER_2.getNickname());
    public static final Player PLAYER_3 = new Player(33, PLAYER_TEAM_2.getId(), MEMBER_3.getNickname());
    public static final Player PLAYER_4 = new Player(34, PLAYER_TEAM_5.getId(), MEMBER_2.getNickname());
    public static final Player PLAYER_5 = new Player(35, PLAYER_TEAM_6.getId(), MEMBER_1.getNickname());
    public static final Player PLAYER_6 = new Player(36, PLAYER_TEAM_7.getId(), MEMBER_2.getNickname());

    public static final List<Player> PLAYERS = Arrays.asList(PLAYER_1, PLAYER_2, PLAYER_3, PLAYER_4, PLAYER_5, PLAYER_6);

    public static final GroupMonthlyScore GROUP_MONTHLY_SCORE_1 = new GroupMonthlyScore(37, GROUP_1.getId(), 2019, 3, 8);
    public static final GroupMonthlyScore GROUP_MONTHLY_SCORE_2 = new GroupMonthlyScore(38, GROUP_1.getId(), 2020, 3, 8);
    public static final GroupMonthlyScore GROUP_MONTHLY_SCORE_3 = new GroupMonthlyScore(39, GROUP_1.getId(), 2020, 3, 9);
    public static final GroupMonthlyScore GROUP_MONTHLY_SCORE_4 = new GroupMonthlyScore(40, GROUP_1.getId(), 2020, 4, 10);
    public static final GroupMonthlyScore GROUP_MONTHLY_SCORE_5 = new GroupMonthlyScore(41, GROUP_3.getId(), 2020, 1, 2);
    public static final GroupMonthlyScore GROUP_MONTHLY_SCORE_6 = new GroupMonthlyScore(42, GROUP_2.getId(), 2019, 4, 12);
    public static final GroupMonthlyScore GROUP_MONTHLY_SCORE_7 = new GroupMonthlyScore(43, GROUP_2.getId(), 2020, 1, 1);
    ...
    //Monthly scores 1
    public static final Score SCORE_1 = new Score(44, GROUP_MONTHLY_SCORE_1.getId(), MEMBER_1.getId(), 70);
    public static final Score SCORE_2 = new Score(45, GROUP_MONTHLY_SCORE_1.getId(), MEMBER_4.getId(), 45);
    public static final Score SCORE_3 = new Score(46, GROUP_MONTHLY_SCORE_1.getId(), MEMBER_5.getId(), 60);

    //Monthly scores 2
    public static final Score SCORE_4 = new Score(47, GROUP_MONTHLY_SCORE_2.getId(), MEMBER_1.getId(), 40);
    public static final Score SCORE_5 = new Score(48, GROUP_MONTHLY_SCORE_2.getId(), MEMBER_4.getId(), 65);
    public static final Score SCORE_6 = new Score(49, GROUP_MONTHLY_SCORE_2.getId(), MEMBER_5.getId(), 80);

    //Monthly scores 3
    public static final Score SCORE_7 = new Score(50, GROUP_MONTHLY_SCORE_3.getId(), MEMBER_1.getId(), 90);
    public static final Score SCORE_8 = new Score(51, GROUP_MONTHLY_SCORE_3.getId(), MEMBER_4.getId(), 55);
    public static final Score SCORE_9 = new Score(52, GROUP_MONTHLY_SCORE_3.getId(), MEMBER_5.getId(), 30);

    //Monthly scores 4
    public static final Score SCORE_10 = new Score(53, GROUP_MONTHLY_SCORE_4.getId(), MEMBER_1.getId(), 100);
    public static final Score SCORE_11 = new Score(54, GROUP_MONTHLY_SCORE_4.getId(), MEMBER_4.getId(), 20);
    public static final Score SCORE_12 = new Score(55, GROUP_MONTHLY_SCORE_4.getId(), MEMBER_5.getId(), 5);

    //Monthly scores 5
    public static final Score SCORE_13 = new Score(56, GROUP_MONTHLY_SCORE_5.getId(), MEMBER_1.getId(), 30);
    public static final Score SCORE_14 = new Score(57, GROUP_MONTHLY_SCORE_5.getId(), MEMBER_3.getId(), 10);
    ...
    //Category 1
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_1 = new GroupCategorySkillRating(58, GROUP_1.getId(), GROUP_MEMBER_1.getMemberId(),
            BG_CATEGORY_1.getId(), 1700.00, 14);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_2 = new GroupCategorySkillRating(59, GROUP_1.getId(), GROUP_MEMBER_5.getMemberId(),
            BG_CATEGORY_1.getId(), 1700.00, 13);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_3 = new GroupCategorySkillRating(60, GROUP_1.getId(), GROUP_MEMBER_6.getMemberId(),
            BG_CATEGORY_1.getId(), 1250.25, 26);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_4 = new GroupCategorySkillRating(61, GROUP_1.getId(), GROUP_MEMBER_7.getMemberId(),
            BG_CATEGORY_1.getId(), 1600.42, 10);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_5 = new GroupCategorySkillRating(62, GROUP_1.getId(), GROUP_MEMBER_8.getMemberId(),
            BG_CATEGORY_1.getId(), 1800.00, 8);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_6 = new GroupCategorySkillRating(63, GROUP_1.getId(), GROUP_MEMBER_9.getMemberId(),
            BG_CATEGORY_1.getId(), 1400.12, 4);

    //Category 2
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_7 = new GroupCategorySkillRating(64, GROUP_1.getId(), GROUP_MEMBER_1.getMemberId(),
            BG_CATEGORY_2.getId(), 1550.00, 2);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_8 = new GroupCategorySkillRating(65, GROUP_1.getId(), GROUP_MEMBER_5.getMemberId(),
            BG_CATEGORY_2.getId(), 1600.00, 3);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_9 = new GroupCategorySkillRating(66, GROUP_1.getId(), GROUP_MEMBER_6.getMemberId(),
            BG_CATEGORY_2.getId(), 2000.00, 300);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_10 = new GroupCategorySkillRating(67, GROUP_1.getId(), GROUP_MEMBER_7.getMemberId(),
            BG_CATEGORY_2.getId(), 1140.00, 72);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_11 = new GroupCategorySkillRating(68, GROUP_1.getId(), GROUP_MEMBER_8.getMemberId(),
            BG_CATEGORY_2.getId(), 1372.00, 64);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_12 = new GroupCategorySkillRating(69, GROUP_1.getId(), GROUP_MEMBER_9.getMemberId(),
            BG_CATEGORY_2.getId(), 900.00, 104);

    //Category 3
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_13 = new GroupCategorySkillRating(70, GROUP_1.getId(), GROUP_MEMBER_1.getMemberId(),
            BG_CATEGORY_3.getId(), 1500.00, 1);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_14 = new GroupCategorySkillRating(71, GROUP_1.getId(), GROUP_MEMBER_2.getMemberId(),
            BG_CATEGORY_3.getId(), 1546.00, 2);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_15 = new GroupCategorySkillRating(72, GROUP_1.getId(), GROUP_MEMBER_3.getMemberId(),
            BG_CATEGORY_3.getId(), 1235.00, 30);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_16 = new GroupCategorySkillRating(73, GROUP_1.getId(), GROUP_MEMBER_5.getMemberId(),
            BG_CATEGORY_3.getId(), 1862.00, 20);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_17 = new GroupCategorySkillRating(74, GROUP_1.getId(), GROUP_MEMBER_6.getMemberId(),
            BG_CATEGORY_3.getId(), 1200.00, 300);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_18 = new GroupCategorySkillRating(75, GROUP_1.getId(), GROUP_MEMBER_7.getMemberId(),
            BG_CATEGORY_3.getId(), 1500.00, 80);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_19 = new GroupCategorySkillRating(76, GROUP_1.getId(), GROUP_MEMBER_8.getMemberId(),
            BG_CATEGORY_3.getId(), 1400.00, 41);
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_20 = new GroupCategorySkillRating(77, GROUP_1.getId(), GROUP_MEMBER_9.getMemberId(),
            BG_CATEGORY_3.getId(), 1300.00, 25);

    //Group 2's skill ratings
    //Category 1
    public static final GroupCategorySkillRating GROUP_CATEGORY_SKILL_RATING_21 = new GroupCategorySkillRating(78, GROUP_2.getId(), GROUP_MEMBER_2.getMemberId(),
    ...
    public static final List<GroupCategorySkillRating> GROUP_CATEGORY_SKILL_RATINGS = Arrays.asList(GROUP_CATEGORY_SKILL_RATING_1, GROUP_CATEGORY_SKILL_RATING_2, GROUP_CATEGORY_SKILL_RATING_3,
            ...
            GROUP_CATEGORY_SKILL_RATING_19, GROUP_CATEGORY_SKILL_RATING_20, GROUP_CATEGORY_SKILL_RATING_21);

    public static final PlayerSkillRatingChange PLAYER_SKILL_RATING_CHANGE_1 = new PlayerSkillRatingChange(79, TestData.PLAYER_1.getId(), BG_CATEGORY_1.getCategoryName(),
            1775.23, 15.16);
    public static final PlayerSkillRatingChange PLAYER_SKILL_RATING_CHANGE_2 = new PlayerSkillRatingChange(80, TestData.PLAYER_1.getId(), BG_CATEGORY_2.getCategoryName(),
            1640.00, 23.11);
    public static final PlayerSkillRatingChange PLAYER_SKILL_RATING_CHANGE_3 = new PlayerSkillRatingChange(81, TestData.PLAYER_2.getId(), BG_CATEGORY_1.getCategoryName(),
            1201.56, -12.4);
    public static final PlayerSkillRatingChange PLAYER_SKILL_RATING_CHANGE_4 = new PlayerSkillRatingChange(82, TestData.PLAYER_3.getId(), BG_CATEGORY_1.getCategoryName(),
            1500.00, 7.5);
